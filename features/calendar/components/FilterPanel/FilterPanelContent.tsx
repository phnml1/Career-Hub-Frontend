  ...
  return (
    <div className='p-4 flex flex-col gap-6'>
      <div className='flex flex-col gap-2'>
        <Label className='text-base font-black text-slate-800 dark:text-slate-50'>
      ...
      {/* 전형 필터 */}
      <div className='flex flex-col gap-2'>
        <div className='font-black text-slate-800 dark:text-slate-50 flex items-center gap-x-1'>
        ...
        {PROCESS_TYPE_OPTIONS.map((option) => {
          ...
          return (
            <Label
              ...
              key={option.value}
              className={cn(
                'flex justify-between font-bold items-center gap-2 text-sm p-2 rounded border border-border',
        ...
        {RESULT_STATUS_OPTIONS.map((option) => {
          ...
          return (
            <Label
              ...
              key={option.value}
              className={cn(
                'flex justify-between items-center gap-2 font-bold text-sm p-2 rounded border border-border',
                'cursor-pointer hover:scale-[1.02]',
                'transition-colors duration-100 ease-linear',
                isChecked &&
                  RESULT_STATUS_META[
